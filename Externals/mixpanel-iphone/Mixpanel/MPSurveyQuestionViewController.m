...
//MOK adjusts
    CGFloat promptHeight = UIDeviceOrientationIsPortrait((UIDeviceOrientation)[UIApplication sharedApplication].statusBarOrientation) ? 72 : 48;
...
- (void)viewWillLayoutSubviews
{
    ...
    //MOK adds
    _textViewHeight.constant = UIDeviceOrientationIsPortrait((UIDeviceOrientation)[UIApplication sharedApplication].statusBarOrientation) ? 72 : 48;
}
